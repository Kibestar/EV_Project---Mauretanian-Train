...
\input{EV_Project - Mauretanian Train/chapters/01_Introduction}
\newpage
\input{EV_Project - Mauretanian Train/chapters/02_Powertrain_design}
\newpage
\input{EV_Project - Mauretanian Train/chapters/03_Simulation}
