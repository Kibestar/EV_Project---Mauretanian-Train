...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\linewidth]{EV_Project - Mauretanian Train/plots/Battery_model_ss.PNG}
    \caption{Battey model of the LTO Battery together with controller in QSS.}
    \label{fig:Battery_model}
\end{figure}
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\linewidth]{EV_Project - Mauretanian Train/plots/charging_model_ss.PNG}
    \caption{Charging model of the charging island infrastructure for on.}
    \label{fig:Battery_model}
\end{figure}